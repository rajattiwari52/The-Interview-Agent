      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 items-start">
          ...
          <div className="bg-white dark:bg-[#0B0F19]/90 border border-gray-200/80 dark:border-slate-800/80 rounded-xl p-4 text-center shadow-2xs backdrop-blur-md">
            ...
            <div className="relative w-28 h-28 mx-auto flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-xl font-bold text-gray-900 dark:text-white font-sans">{analytics.totalScore}</span>
        ...
        <div className="lg:col-span-7 space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
            ...
            <div className="bg-white dark:bg-[#0B0F19]/90 border border-gray-200/80 dark:border-slate-800/80 border-l-3 border-l-red-500 dark:border-l-red-500 rounded-lg p-2.5 shadow-2xs backdrop-blur-md">
              <p className="text-[9px] text-gray-500 dark:text-slate-400 mb-0.5">Experience Match</p>
              <p className="text-lg font-bold text-red-600 dark:text-red-400">{analytics.experienceMatch}%</p>
            </div>
            <div className="bg-white dark:bg-[#0B0F19]/90 border border-gray-200/80 dark:border-slate-800/80 border-l-3 border-l-red-500 dark:border-l-red-500 rounded-lg p-2.5 shadow-2xs backdrop-blur-md">
              <p className="text-[9px] text-gray-500 dark:text-slate-400 mb-0.5">Keyword Match</p>
              <p className="text-lg font-bold text-red-600 dark:text-red-400">{analytics.keywordMatch}%</p>
            </div>
          </div>
