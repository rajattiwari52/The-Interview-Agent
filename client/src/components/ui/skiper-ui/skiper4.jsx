...
const Options = ({ scale, setScale, gap, setGap, setFlexDirection }) => {
...
export const ThemeToggleButton1 = ({ className = "" }) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded-full bg-black text-white transition-all duration-300 active:scale-95 cursor-pointer",
        className
      )}
      onClick={toggleTheme}
    >
...
export const ThemeToggleButton2 = ({ className = "" }) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded-full transition-all duration-300 active:scale-95 cursor-pointer flex items-center justify-center",
        isDark ? "bg-slate-800 text-white border border-slate-700 shadow-xs" : "bg-white text-gray-800 border border-gray-200 shadow-2xs",
        className
      )}
      onClick={toggleTheme}
    >
